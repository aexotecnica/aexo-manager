...
insert  into `movimientosaldomes`(`mes`,`anio`,`saldo`,`fechaCarga`) values (1,2015,'56667.02','0000-00-00 00:00:00'),(2,2015,'-22534.48','0000-00-00 00:00:00');
...
insert  into `usuario`(`idUsuario`,`username`,`pass`,`nombre`,`apellido`) values (1,'arothar','orionale','Alejandro','Rothar'),(3,'admin','aexoadmin2015','Administrador','Aexo');
